							...
							try {
								...
								if (
									...
									if (
										...
										if (this.settings.buttonEnabled == false ){ console.log("disabled"); ghostButton.setAttribute("style", "display: none;") }  else { console.log("enabled"); ghostButton.setAttribute("style", "") };
